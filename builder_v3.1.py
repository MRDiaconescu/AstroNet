	...
	class Sphere(): 
		...
		#n
			def create_instances_for_two_levels(self):
				...
				# [[[item[0],item[1]], [item[1], item[0]]] for item in Self.b_first_level_connections_list_2]
				print(B_first_level_connections_list_3_1)
				print(B_first_level_connections_list_3_2)
				print(B_first_level_connections_list_3_3)
				...
				print(B_second_level_connections_list_3_1)
				print(B_second_level_connections_list_3_2)
				print(B_second_level_connections_list_3_3)
				...
				# print("list", polyhedron1_connections)
