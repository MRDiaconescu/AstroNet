...
'''
builder version 3.1, 23 November 2021
...
class AstroNet():
	...
	class Sphere(): 
		...
		class Polyhedron():
			...
			def create_the_polyhedron(self):
				...
				self.build_first_level_connections_list(line2); self.build_first_level_connections_list(line46)
				self.build_first_level_connections_list(line3); self.build_first_level_connections_list(line47)
				self.build_first_level_connections_list(line4); self.build_first_level_connections_list(line48)
				self.build_first_level_connections_list(line5); self.build_first_level_connections_list(line49)
				self.build_first_level_connections_list(line6); self.build_first_level_connections_list(line50)
				self.build_first_level_connections_list(line7); self.build_first_level_connections_list(line51)
				self.build_first_level_connections_list(line8); self.build_first_level_connections_list(line52)


				# third dimension

				self.build_first_level_connections_list(line25); self.build_first_level_connections_list(line70)
				self.build_first_level_connections_list(line26); self.build_first_level_connections_list(line71)
				self.build_first_level_connections_list(line27); self.build_first_level_connections_list(line72)
				self.build_first_level_connections_list(line28); self.build_first_level_connections_list(line73)
				self.build_first_level_connections_list(line29); self.build_first_level_connections_list(line74)
				self.build_first_level_connections_list(line30); self.build_first_level_connections_list(line75)
				self.build_first_level_connections_list(line31); self.build_first_level_connections_list(line76)
				self.build_first_level_connections_list(line32); self.build_first_level_connections_list(line77)
				...
				self.build_second_level_connections_list(line9); self.build_second_level_connections_list(line53)
				self.build_second_level_connections_list(line10); self.build_second_level_connections_list(line54)
				self.build_second_level_connections_list(line11); self.build_second_level_connections_list(line55)
				self.build_second_level_connections_list(line12); self.build_second_level_connections_list(line56)
				self.build_second_level_connections_list(line13); self.build_second_level_connections_list(line57)
				self.build_second_level_connections_list(line14); self.build_second_level_connections_list(line58)
				self.build_second_level_connections_list(line15); self.build_second_level_connections_list(line59)
				self.build_second_level_connections_list(line16); self.build_second_level_connections_list(line60)



				# third dimension

				self.build_second_level_connections_list(line33); self.build_second_level_connections_list(line78)
				self.build_second_level_connections_list(line34); self.build_second_level_connections_list(line79)
				self.build_second_level_connections_list(line35); self.build_second_level_connections_list(line80)
				self.build_second_level_connections_list(line36); self.build_second_level_connections_list(line81)
				self.build_second_level_connections_list(line37); self.build_second_level_connections_list(line82)
				self.build_second_level_connections_list(line38); self.build_second_level_connections_list(line83)
				self.build_second_level_connections_list(line39); self.build_second_level_connections_list(line84)
				self.build_second_level_connections_list(line40); self.build_second_level_connections_list(line85)

				self.print_second_level_connections_list()


				#second dimension 


				self.build_third_level_connections_list(line17); self.build_third_level_connections_list(line61)
				self.build_third_level_connections_list(line18); self.build_third_level_connections_list(line62)
				self.build_third_level_connections_list(line19); self.build_third_level_connections_list(line63)
				self.build_third_level_connections_list(line20); self.build_third_level_connections_list(line64)
				self.build_third_level_connections_list(line21); self.build_third_level_connections_list(line65)
				self.build_third_level_connections_list(line22); self.build_third_level_connections_list(line66)
				self.build_third_level_connections_list(line23); self.build_third_level_connections_list(line67)
				self.build_third_level_connections_list(line24); self.build_third_level_connections_list(line68)


				#third dimension

				self.build_third_level_connections_list(line41); self.build_third_level_connections_list(line86)
				self.build_third_level_connections_list(line42); self.build_third_level_connections_list(line87)
				self.build_third_level_connections_list(line43); self.build_third_level_connections_list(line88)
				self.build_third_level_connections_list(line44); self.build_third_level_connections_list(line89)


				self.print_third_level_connections_list()
		...
		class Child(Polyhedron):
			...
			def __init__(self, name, n):
				self.name = name
				self.n = n;
				self.B_first_level_connections_list_2 = []
			...
			def create_instances_for_two_levels(self):
				...
				polyhedron3_connections1 = polyhedron3.first_level_connections()
				
				polyhedron1_connection_points = [item for item in polyhedron1_connections if ((item[1] != "Y") and (item[1] != "Y'"))]
				...
				for item, item1 in zip(polyhedron1_connection_points, polyhedron2_connection1_points):
					self.B_first_level_connections_list_2.append([item, item1])
				print(self.B_first_level_connections_list_2)


				for item, item1 in zip(polyhedron2_connection2_points, polyhedron3_connection1_points):
					self.B_second_level_connections_list_2.append([item, item1])
				print(self.B_second_level_connections_list_2)

				#3rd dimension
				#first level

				B_first_level_connections_list_3_1 = [item for item in self.B_first_level_connections_list_2]
				B_first_level_connections_list_3_2 = [item[0] for item in B_first_level_connections_list_3_1]
				B_first_level_connections_list_3_3 = [item[1] for item in B_first_level_connections_list_3_1]

				for item, item1 in zip(B_first_level_connections_list_3_2, B_first_level_connections_list_3_3):
					self.B_first_level_connections_list_3.append([item[0], item1[0]])
				...
				B_second_level_connections_list_3_3 = [item[1] for item in B_second_level_connections_list_3_1]

				for item, item1 in zip(B_second_level_connections_list_3_2, B_second_level_connections_list_3_3):
					self.B_second_level_connections_list_3.append([item[0], item1[0]])


				print(self.B_second_level_connections_list_3)
			...
			def create_instances_for_three_levels(self):
				...
				child = self.create_instances_for_two_levels()
				polyhedron3 = AstroNet().Sphere().Polyhedron().create_the_polyhedron()
				polyhedron_3rd_level = AstroNet().Sphere().Polyhedron().create_the_polyhedron()

				polyhedron3_connections2 = polyhedron3.third_level_connections()
				polyhedron_3rd_level_connections1 = polyhedron_3rd_level.first_level_connections()

				polyhedron3_connection1_points = [item for item in polyhedron3_connections2 if ((item[1] != "Y") and (item[1] != "Y'"))]
				polyhedron_3rd_level_connection1_points = [item for item in polyhedron_3rd_level_connections1]
				
				# 2nd dimension

				for item, item1 in zip(polyhedron3_connection1_points, polyhedron_3rd_level_connection1_points):
					self.B_third_level_connections_2.append([item, item1])
				print(self.B_third_level_connections_2)
